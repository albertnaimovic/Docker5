...
conn = psycopg2.connect(
    database="flask_db", user="postgres", password="root", host="localhost", port="5432"
)
...
@app.route("/<text>")
def typetext(text):
    collection.insert_one({"message": f"{text}"})
...
def postgres():
    ...
    return render_template("postgress.html", data=data)
...
def create():
    ...
    return redirect(url_for("postgress"))
